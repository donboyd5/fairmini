...
LHS is log of real per-capita consumer expenditures on services.

RHS has measures of per-capita income, per-capita assets, short-term interest rate, age distribution, and lagged DV.

Estimated assuming first-order autocorrelation.
