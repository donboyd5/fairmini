...
vars <- c("AA", "AG1", "AG2", "AG3", "CN", "CS", "EX", "POP", "RS", "YD") 
popvars <- c("AA", "CN", "CS", "EX", "YD")
lnvars <- paste0(popvars, "_pop")
d1vars <- "CN_pop_ln"
l1vars <- c("AA_pop_ln", "AG1", "AG2", "AG3", "C2", "CN_pop_ln", "CN_pop_ln_d1", "CS_pop_ln", "EX_pop_ln", "YD_pop_ln", "RS")
